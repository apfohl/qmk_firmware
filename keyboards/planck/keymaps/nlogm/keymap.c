...
KC_LCTL, _______, _______, _______, _______, _______, KC_MINS, KC_EQL,  KC_GRV,  KC_LBRC, KC_RBRC, KC_BSLS,
KC_LSFT, _______, _______, _______, _______, _______, KC_UNDS, KC_PLUS, KC_TILD, KC_LCBR, KC_LCBR, KC_PIPE,
_______, _______, _______, KC_LGUI, _______, KC_SPC,  KC_ENT,  _______, KC_RALT, _______, _______, _______
),
